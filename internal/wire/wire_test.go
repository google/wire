...
func loadTestCase(root string, wireGoSrc []byte) (*testCase, error) {
	...
	goFiles := map[string][]byte{
		"github.com/zeriontech/google-wire/wire.go": wireGoSrc,
	}
...
func (test *testCase) materialize(gopath string) error {
	...
	// Add go.mod files to example.com and github.com/zeriontech/google-wire.
	const importPath = "example.com"
	const depPath = "github.com/zeriontech/google-wire"
